...
export const ICON_PATHS = {
  ...
  sprout: [
    'M16 27 C 16 22.5, 16 18, 16 13.5',
    'M16 14.5 C 11.5 14, 8.5 11, 8 7 C 12.5 7.5, 15.5 10.5, 16 14.5 Z',
    'M16 14.5 C 20.5 14, 23.5 11, 24 7 C 19.5 7.5, 16.5 10.5, 16 14.5 Z',
    'M10.5 27 H 21.5',
  ],
  sun: [
    circle(16, 16, 5.8),
